...
@Component({
  selector: 'app-movie-tv-shows-page',
  standalone: false,
  templateUrl: './movie-tv-shows-page.component.html',
  styleUrl: './movie-tv-shows-page.component.css'
})
export class MovieTvShowsPageComponent {
 movies: any[] = [];
