...
@Component({
  selector: 'app-movie-cartoon-page',
  standalone: false,
  templateUrl: './movie-cartoon-page.component.html',
  styleUrl: './movie-cartoon-page.component.css'
})
export class MovieCartoonPageComponent {
  movies: any[] = [];
  isLoading = true;
